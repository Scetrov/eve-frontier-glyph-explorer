...
- **Cycle-date reference** — the Phase and Era/Cycle timestamps in [`data/cycles.json`](data/cycles.json) were supplied for this explorer. Era 6 boundaries were aligned to confirmed whole-hour noon UTC cutovers from server-transition context.
